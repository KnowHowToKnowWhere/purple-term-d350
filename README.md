...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/purple-term-d350)
...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/purple-term-d350#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/purple-term-d350
```

A live public deployment of this template is available at [https://purple-term-d350.templates.workers.dev](https://purple-term-d350.templates.workers.dev)
